...
for layer in layers:
    ...
    for subject in subjects:
        ...
        for fold_idx, (train_idx, test_idx) in tqdm.tqdm(enumerate(outer_cv.split(brain_data))):
            ...
            set_seed(42)
            # model = AttentiveStim2BrainNet(d_model=128, nhead=2, num_layers=2, time_in=audio_timep, time_out=brain_timep,
        ...
        to_save_path = f"{base_path}/matteoc/podcast/subj_data/sub_{subject}_tcn"
